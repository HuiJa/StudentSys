...
VALUES (8148888, '实践', '大二暑假在超市做过兼职', '2015-7-1', '2015-8-30'),
  ...
  UPDATE `student_sys`.`student` SET `sresult`='考公(北京)' WHERE `sid`='08146666';
UPDATE `student_sys`.`student` SET `sresult`='保研(华中科技大学)' WHERE `sid`='08147777';
UPDATE `student_sys`.`student` SET `sresult`='工作(南京)' WHERE `sid`='08148888';